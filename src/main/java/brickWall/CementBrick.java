...
/**
 * CementBrick class which inherits from superclass, Brick
 */
public class CementBrick extends Brick {
    ...
    /**
     * constructor of class CementBrick which set value for bricks' position, size, color, strength, brokenFlag in superclass, Brick
